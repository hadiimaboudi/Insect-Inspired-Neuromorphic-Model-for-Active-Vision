function [MBON_before, Test1,Test2,Test3, MBONxx, MBONyy,MBON_after_test2]=Learning_ActiveVision_rejection(Pattern,Q,W,winsize,Laminafiltersize,NFrames,PixelShift)
...
MyImagez=take_patch_stimuli(z,winsize,NFrames,PixelShift,posx,posy,1);
...
for sampletest=1:20
[MBONx, MBONy]=ACModel_response(MyImagex,MyImagey,V,O,Q,W,gE,winsize,Laminafiltersize,NFrames,PixelShift);
Test1(beeind,sampletest)=MBONx-MBONy;
end

for sampletest=1:20
[MBONx, MBONy]=ACModel_response(MyImagex,MyImagez,V,O,Q,W,gE,winsize,Laminafiltersize,NFrames,PixelShift);
Test2(beeind,sampletest)=MBONx-MBONy;
end

for sampletest=1:20
[MBONx, MBONy]=ACModel_response(MyImagez,MyImagey,V,O,Q,W,gE,winsize,Laminafiltersize,NFrames,PixelShift);
Test3(beeind,sampletest)=MBONx-MBONy;
end
% for sampletest=1:20
% 
% indstimuli=1;
